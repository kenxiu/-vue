  ...
  <div class="sales-board">
    <div class="sales-board-intro">
      ...
      <p>是指在获得网站访问量基本数据的情况下对有关数据进行统计、分析，从中发现用户访问网站的规律，
        ...
        并为进一步修正或重新制定网络营销策略提供依据。当然这样的定义是站在网络营销管理的角度来考虑的</p>
    </div>
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-mul-chooser :selections="versionList" @on-change="onParamChange('versions', $event)">
          </v-mul-chooser>
        </div>
      </div>
      <div class="sales-board-line">
  ...
  export default {
    ...
    methods: {
      ...
      confirmBuy() {
        ...
        this.$http.get('http://localhost:8080/static/db.json', reqParams)
        .then((res) => {
          this.orderId = res.data.getOrderList.orderId
